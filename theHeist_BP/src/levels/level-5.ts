...
{
    Utilities.setBlock(new Vector(6915, Utilities.levelPlayingHeight, 141), "theheist:custom_door_3_bottom", {"theheist:unlocked": false, "minecraft:cardinal_direction": "east"});
    LevelConstructor.keycardReader(new VectorXZ(6914.5, 143.5), "green", [
        {
            "type": "set_block", "do": { "x": 6915, "y": Utilities.levelPlayingHeight, "z": 141, "block": "theheist:custom_door_3_bottom", "permutations": { "minecraft:cardinal_direction": "east", "theheist:open": true } }
        },
        {
...
{
    Utilities.setBlock(new Vector(6924, Utilities.levelPlayingHeight, 121), "theheist:custom_door_3_bottom", {"theheist:unlocked": false, "minecraft:cardinal_direction": "north"});
    Utilities.setBlock(new Vector(6924, Utilities.levelPlayingHeight, 120), "theheist:custom_door_3_bottom", {"theheist:unlocked": false, "minecraft:cardinal_direction": "south"});
    LevelConstructor.keypad(new VectorXZ(6923.5, 122.5), 3, BlockRotation.NORTH, [{
        "type": "set_block", "do": { "x": 6924, "y": Utilities.levelPlayingHeight, "z": 121, "block": "theheist:custom_door_3_bottom", "permutations": { "minecraft:cardinal_direction": "north" } }, "delay": 40
    },
    {
        "type": "hack_console", "do": { "x": 6923, "z": 119 }
    }]);
    LevelConstructor.keypad(new VectorXZ(6923.5, 119.5), 3, BlockRotation.SOUTH, [{
        "type": "set_block", "do": { "x": 6924, "y": Utilities.levelPlayingHeight, "z": 120, "block": "theheist:custom_door_3_bottom", "permutations": { "minecraft:cardinal_direction": "south" } }, "delay": 40
    },
    {
...
{
    Utilities.setBlock(new Vector(6938, Utilities.levelPlayingHeight, 126), "theheist:custom_door_2_bottom", {"minecraft:cardinal_direction": "east","theheist:unlocked":false});
    LevelConstructor.keypad(new VectorXZ(6937.5, 125.5), 2, BlockRotation.EAST, [{
        "type": "set_block", "do": { 'x': 6938, 'y': Utilities.levelPlayingHeight, 'z': 126, "block": "theheist:custom_door_2_bottom", "permutations": { "minecraft:cardinal_direction": "east" } }, "delay": 40
    }]);
...
{
    Utilities.setBlock(new Vector(6932, Utilities.levelPlayingHeight, 132), "theheist:custom_door_2_bottom", {"minecraft:cardinal_direction": "west","theheist:unlocked":false});
    LevelConstructor.keypad(new VectorXZ(6933.5, 133.5), 2, BlockRotation.WEST, [{
        "type": "set_block", "do": { 'x': 6932, 'y': Utilities.levelPlayingHeight, 'z': 132, "block": "theheist:custom_door_2_bottom", "permutations": { "minecraft:cardinal_direction": "west" } }, "delay": 40
    },
    {
        "type": "hack_console", "do": { "x": 6930, "z": 133 }
    }]);
    Utilities.setBlock(new Vector(6931, Utilities.levelPlayingHeight, 132), "theheist:custom_door_2_bottom", {"minecraft:cardinal_direction": "east","theheist:unlocked":false});
    LevelConstructor.keypad(new VectorXZ(6930.5, 133.5), 2, BlockRotation.EAST, [{
        "type": "set_block", "do": { 'x': 6931, 'y': Utilities.levelPlayingHeight, 'z': 132, "block": "theheist:custom_door_2_bottom", "permutations": { "minecraft:cardinal_direction": "east" } }, "delay": 40
    },
    {
...
{
    Utilities.setBlock(new Vector(6928, Utilities.levelPlayingHeight, 144), "theheist:custom_door_3_bottom", {"theheist:unlocked": false, "minecraft:cardinal_direction": "south"});
    LevelConstructor.keycardReader(new VectorXZ(6926.5, 143.5), "red", [
        {
            "type": "set_block", "do": { "x": 6928, "y": Utilities.levelPlayingHeight, "z": 144, "block": "theheist:custom_door_3_bottom", "permutations": { "minecraft:cardinal_direction": "south", "theheist:open": true } }
        },
        {
            "type": "play_sound", "do": { "soundID": "random.door_open" }
        }
    ...
    Utilities.setBlock(new Vector(6935, Utilities.levelPlayingHeight, 150), "theheist:custom_door_3_bottom", {"minecraft:cardinal_direction": "east","theheist:unlocked":false});
    LevelConstructor.keypad(new VectorXZ(6934.5, 151.5), 3, BlockRotation.EAST, [{
        "type": "set_block", "do": { 'x': 6935, 'y': Utilities.levelPlayingHeight, 'z': 150, "block": "theheist:custom_door_3_bottom", "permutations": { "minecraft:cardinal_direction": "east" } }, "delay": 40
    }]);
...
{
    Utilities.setBlock(new Vector(6880, Utilities.levelPlayingHeight, 121), "theheist:custom_door_2_bottom", {"minecraft:cardinal_direction": "north","theheist:unlocked":false});
    LevelConstructor.keycardReader(new VectorXZ(6878.5, 122.5), "yellow", [{
        "type": "set_block", "do": { 'x': 6880, 'y': Utilities.levelPlayingHeight, 'z': 121, "block": "theheist:custom_door_2_bottom", "permutations": { "minecraft:cardinal_direction": "north", "theheist:open": true } }
    },
    {
        "type": "play_sound", "do": { "soundID": "random.door_open" }
    }]);
    ...
    LevelConstructor.keypad(new VectorXZ(6883.5, 112.5), 3, BlockRotation.NORTH, [{
        "type": "set_block", "do": { 'x': 6882, 'y': Utilities.levelPlayingHeight, 'z': 111, "block": "theheist:custom_door_3_bottom", "permutations": { "minecraft:cardinal_direction": "north" } }, "delay": 40
    }]);
...
{
    Utilities.setBlock(new Vector(6909, Utilities.levelPlayingHeight, 103), "theheist:custom_door_3_bottom", {"minecraft:cardinal_direction": "west","theheist:unlocked":false});
    LevelConstructor.keypad(new VectorXZ(6910.5, 102.5), 3, BlockRotation.WEST, [{
        "type": "set_block", "do": { 'x': 6909, 'y': Utilities.levelPlayingHeight, 'z': 103, "block": "theheist:custom_door_3_bottom", "permutations": { "minecraft:cardinal_direction": "west" } }, "delay": 40
    },
    {
        "type": "hack_console", "do": { "x": 6907, "z": 102 }
    }]);
    Utilities.setBlock(new Vector(6908, Utilities.levelPlayingHeight, 103), "theheist:custom_door_3_bottom", {"minecraft:cardinal_direction": "east","theheist:unlocked":false});
    LevelConstructor.keypad(new VectorXZ(6907.5, 102.5), 3, BlockRotation.EAST, [{
        "type": "set_block", "do": { 'x': 6908, 'y': Utilities.levelPlayingHeight, 'z': 103, "block": "theheist:custom_door_3_bottom", "permutations": { "minecraft:cardinal_direction": "east" } }, "delay": 40
    },
    {
    ...
    Utilities.setBlock(new Vector(6902, Utilities.levelPlayingHeight, 110), "minecraft:wooden_door", {"direction":2});
} // Chief of Staff

{
    Utilities.setBlock(new Vector(6912, Utilities.levelPlayingHeight, 86), "theheist:custom_door_2_bottom", {"minecraft:cardinal_direction": "north","theheist:unlocked":false});
    LevelConstructor.keycardReader(new VectorXZ(6914.5, 87.5), "green", [{
        "type": "set_block", "do": { 'x': 6912, 'y': Utilities.levelPlayingHeight, 'z': 86, "block": "theheist:custom_door_2_bottom", "permutations": { "minecraft:cardinal_direction": "north", "theheist:open": true } }
    },
    {
        "type": "play_sound", "do": { "soundID": "random.door_open" }
    }]);
    ...
    Utilities.setBlock(new Vector(6912, Utilities.levelPlayingHeight, 74), "theheist:custom_door_3_bottom", {"minecraft:cardinal_direction": "north","theheist:unlocked":false});
    LevelConstructor.keypad(new VectorXZ(6911.5, 75.5), 3, BlockRotation.NORTH, [{
        "type": "set_block", "do": { 'x': 6912, 'y': Utilities.levelPlayingHeight, 'z': 74, "block": "theheist:custom_door_3_bottom", "permutations": { "minecraft:cardinal_direction": "north" } }, "delay": 40
    }]);
...
{
    // Men's
    Utilities.setBlock(new Vector(6902, Utilities.levelPlayingHeight, 121), "minecraft:wooden_door", { "minecraft:cardinal_direction": BlockRotation.WEST });
    Utilities.setBlock(new Vector(6901, Utilities.levelPlayingHeight, 117), "minecraft:wooden_door", { "minecraft:cardinal_direction": BlockRotation.EAST });
    // Women's
    Utilities.setBlock(new Vector(6909, Utilities.levelPlayingHeight, 114), "minecraft:wooden_door", { "minecraft:cardinal_direction": BlockRotation.SOUTH });
    Utilities.setBlock(new Vector(6905, Utilities.levelPlayingHeight, 115), "minecraft:wooden_door", { "minecraft:cardinal_direction": BlockRotation.NORTH });
    Utilities.setBlock(new Vector(6905, Utilities.levelPlayingHeight, 113), "minecraft:wooden_door", { "minecraft:cardinal_direction": BlockRotation.NORTH });
} // Bathrooms

{
    Utilities.setBlock(new Vector(6878, Utilities.levelPlayingHeight, 156), "theheist:custom_door_4_bottom_l", { "minecraft:cardinal_direction": "west", "theheist:unlocked": false });
    Utilities.setBlock(new Vector(6878, Utilities.levelPlayingHeight, 155), "theheist:custom_door_4_bottom_r", { "minecraft:cardinal_direction": "west", "theheist:unlocked": false });
    LevelConstructor.keycardReader(new VectorXZ(6879.5, 153.5), "green", [
        {
            "type": "set_block", "do": { "x": 6878, "y": Utilities.levelPlayingHeight, "z": 156, "block": "theheist:custom_door_4_bottom_l", "permutations": { "minecraft:cardinal_direction": "west", "theheist:open": true } }
        },
        {
            "type": "set_block", "do": { "x": 6878, "y": Utilities.levelPlayingHeight, "z": 155, "block": "theheist:custom_door_4_bottom_r", "permutations": { "minecraft:cardinal_direction": "west", "theheist:open": true } }
        },
        {
            "type": "play_sound", "do": { "soundID": "random.door_open" }
        },
