...
{
    LevelConstructor.door4(new VectorXZ(0, 0), new VectorXZ(0, 0), BlockRotation.NORTH);
    LevelConstructor.keycardReader(new VectorXZ(0, 0), "COLOR", [
        {
    ...
    Utilities.setBlock(new Vector(0, Utilities.consoleDisplayHeight, 0), "minecraft:lever", { "lever_direction": "north" });
    LevelConstructor.rechargeStation(new VectorXZ(0, 0), BlockRotation.NORTH);
} // End Level Elevator
