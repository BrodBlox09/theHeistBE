...
"levelCloneInfo": {
	...
	"endX": 4133,
	"endZ": 159,
	"prisonLoc": new Vector(4075.5, 61, 151.5),
	"mapLoc": new Vector(4098, 65, 115)
},
"loadElevatorLoc": new Vector(4101, 71, 123),
...

{
    ...
    Utilities.setBlock(new Vector(4076.5, Utilities.consoleDisplayHeight, 122.5), "lever", { "lever_direction": "east" });
} // Elevator
