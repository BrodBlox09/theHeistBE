import { Vector, BlockPermutation, world, system } from "@minecraft/server";
...
system.runInterval(() => {
    ...
    if ((system.currentTick % 15 == 0)) {
        ...
        cameraMappingArmorStands.forEach((armorStand) => {
            ...
            armorStand.teleport({"x": armorStand.location.x + -(sin(armorStand.getRotation().y) * tpDistance), "y": cameraMappingHeight, "z": armorStand.location.z + (cos(armorStand.getRotation().y) * tpDistance)}, {'dimension': overworld});
